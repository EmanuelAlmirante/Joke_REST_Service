package com.joke.controller.utils;

import com.joke.error.BusinessError;
import com.joke.error.RestError;
import com.joke.error.TechnicalError;
...
@ControllerAdvice
public class ExceptionHandlerController {    @ExceptionHandler(Exception.class)
@ResponseBody
